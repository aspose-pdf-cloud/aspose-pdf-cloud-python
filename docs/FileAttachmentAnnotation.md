...
**opacity** | **float** | Gets or sets icon&#39;s opacity from 0 to 1: 0 - completely transparant, 1 - completely opaque. | [optional] 
**file_description** | **str** | Gets or sets text associated with the file specification.  | [optional] 
**file_name** | **str** | Gets or sets file specification name.  | [optional] 
